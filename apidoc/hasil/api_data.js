define({ "api": [
  ...
  },
  {
    ...
    "version": "0.0.0",
    "filename": "source/code2.js",
    "groupTitle": "User"
  },
  {
    "type": "get",
    "url": "https://niko.com/api/read_user",
    "title": "Zet list of User",
    "name": "GetReadUser",
    "group": "User_Admin",
    "description": "<p>In this case &quot;apiUse&quot; is defined and used. Define blocks with params that will be used in several functions, so you dont have to rewrite them.</p>",
    "parameter": {
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "TakAda",
            "description": "<p>IDCoba Penjelasankah ini</p>"
          }
        ]
      }
    },
